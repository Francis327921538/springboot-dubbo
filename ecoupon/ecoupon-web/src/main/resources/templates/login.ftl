                                         ...
                                         <fieldset>
                                            ...
                                            <label class="block clearfix mart11">
												<span class="block input-icon input-icon-right">
													...
													<input v-model="username"	type="password" class="form-control" name="username"
                                            ...
                                            <%-- <div class="clearfix">
                                            <a href="{basePath}/enterapplicationrecords/recordslist" class="inline">
                                                <!-- <input type="checkbox" name="rememberMe" class="ace" value="true" /> -->
                                                <i class="ace-icon fa fa-arrow-right"></i>
                                                <span class="lbl"> 企业登录</span>
                                            </a>

                                        </div> --%>
                                            <!-- 	<div class="clearfix align2">
                                                    <input type="checkbox" v-model="checked" name="rememberPassword" value="1" style="cursor:pointer;width:14px;height:14px;">
                                                    <span>记住密码</span>
                                                </div> -->
                                            <div id="main">
                                                <div class="demo">
